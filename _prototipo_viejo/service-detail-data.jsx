/* Extended detail copy per service.
   The lighter Service.jsx has the catalog row; this file holds everything
   that lives on the dedicated detail page (timeline, fit, FAQ, gallery).
   Keyed by service id so a single ServiceDetail page handles all six. */
  ...
  estructural: {
    hero: {
      ...
      en: {
        ...
        lede: 'Soft, precise joint manipulation to release the deep tension that builds up in spine, hips, shoulders, and neck. The most-requested session — the one I recommend when someone tells me "I don’t even know where it hurts anymore".',
      },
    },
    timeline: [
