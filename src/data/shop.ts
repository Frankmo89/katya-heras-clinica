...
export type ProductCategoryId = "velas" | "aceites" | "estres" | "rituales";
export type FilterCategoryId = "todo" | ProductCategoryId;
...
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  {
    id: "v1", cat: "velas",
    name:  { es: "Vela Lenta",       en: "Slow Candle" },
  ...
  {
    id: "v2", cat: "velas",
    name:  { es: "Bosque de Tecate", en: "Tecate Forest" },
  ...
  {
    id: "v3", cat: "velas",
    name:  { es: "Hora Azul",        en: "Blue Hour" },
  ...
  {
    id: "a1", cat: "aceites",
    name:  { es: "Aceite Cervical",            en: "Cervical Oil" },
  ...
  {
    id: "a2", cat: "aceites",
    name:  { es: "Aceite Lumbar",              en: "Lumbar Oil" },
  ...
  {
    id: "a3", cat: "aceites",
    name:  { es: "Aceite Esencial · Lavanda",  en: "Lavender Essential Oil" },
  ...
  {
    id: "a4", cat: "aceites",
    name:  { es: "Aceite Esencial · Eucalipto", en: "Eucalyptus Essential Oil" },
  ...
  {
    id: "e1", cat: "estres",
    name:  { es: "Antifaz Pesado",       en: "Weighted Eye Mask" },
  ...
  {
    id: "e2", cat: "estres",
    name:  { es: "Saquito Cervical",     en: "Neck Pillow" },
  ...
  {
    id: "e3", cat: "estres",
    name:  { es: "Cuarzo Rosa de Mano", en: "Rose Quartz Palm Stone" },
  ...
  {
    id: "r1", cat: "rituales",
    name:  { es: "Ritual de Domingo", en: "Sunday Ritual" },
  ...
  {
    id: "r2", cat: "rituales",
    name:  { es: "Ritual de Lunes", en: "Monday Ritual" },
